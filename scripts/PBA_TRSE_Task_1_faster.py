...
NB: As the bus JT matrix is static, we only need to run this for the base
    year, thus no "looped" script is required (looping over possible run codes)
...
grouped_responses['jt'] = grouped_responses['min_duration']/60
