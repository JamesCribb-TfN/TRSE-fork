...
Script to take separate PBA_TRSE_Task_1 outputs and compile into a single
...
compiled_matrix.rename({'jt(mins)': 'jt'}, inplace=True, axis=1)
compiled_matrix = compiled_matrix[['o', 'd', 'jt']]
print(time.strftime("%H:%M:%S - %Y", time.localtime()), '\nDone.')
# Save
